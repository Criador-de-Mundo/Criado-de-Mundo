# 👋 Olá, eu sou o Felipe Madrid

### 🚀 Tech-Driven Content Creator | Social Media & Automação

Desenvolvedor em formação e criador de conteúdo com foco na interseção entre **tecnologia, dados e narrativa visual**. Minha missão é utilizar programação (Python/JS) e Inteligência Artificial para otimizar processos criativos, analisar métricas de engajamento e produzir conteúdo que conecta marcas ao seu público.
...
![Canva/Design](https://img.shields.io/badge/Design-00C4CC?style=for-the-badge&logo=canva&logoColor=white)
![Video Editing](https://img.shields.io/badge/Edição%20de%20Vídeo-999999?style=for-the-badge&logo=adobepremierepro&logoColor=white)
